...
res_train = (res_train-res_train.min())*9/(res_train.max()-res_train.min()) + 1
import statistics
print(statistics.median(res_train))
print(statistics.mean(res_train))
...
res_test = (res_test-res_test.min())*9/(res_test.max()-res_test.min()) + 1
